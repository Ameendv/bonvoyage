  ...
  return /******/ (function (modules) {
                ...
                if (this.currentState !== this.prevState) {
                  ...
                  if (
                    ...
                    if (this.isSelectElement) {
                      ...
                      var activeChoices =
                        this.store.getChoicesFilteredByActive();
              ...
              value: function _onKeyDown(e) {
                ...
                var onDirectionKey = function onDirectionKey() {
                  ...
                  if (hasActiveDropdown || _this16.isSelectOneElement) {
                    ...
                    var directionInt =
                      e.keyCode === downKey || e.keyCode === pageDownKey
                        ? 1
                        : -1;
                    var skipKey =
                      e.metaKey ||
	...
	*/
      ...
      /***/ function (module, exports) {
         ...
         */
        var getParentsUntil = (exports.getParentsUntil =
         ...
         */
        var getElemDistance = (exports.getElemDistance =
          function getElemDistance(el) {
            var location = 0;
            if (el.offsetParent) {
              do {
         ...
         */
        var getWidthOfInput = (exports.getWidthOfInput =
